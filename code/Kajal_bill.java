 ...
 * @author js
 */
public class Kajal_bill extends javax.swing.JFrame {

    /**
     * Creates new form Kajal_bill
     */
    Connection con = null;
    ...
    +"Product Name:-     Maybelline The Colossal Kajal 24Hour Smudge Proof - Deep Black" +"\n"
    +"Price:-            180"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kajal_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
