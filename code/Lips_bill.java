 ...
 * @author js
 */
public class Lips_bill extends javax.swing.JFrame {

    /**
     * Creates new form Lips_bill
     */
    Connection con = null;
    ...
    +"Brand:-            Kay Beauty"+"\n"
    +"Product Name:-     Kay Beauty Matte Lipstick - Red Carpet " +"\n"
    +"Price:-            999"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lips_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
