 ...
 * @author js
 */
public class Com_bill extends javax.swing.JFrame {

    /**
     * Creates new form Com_bill
     */
    Connection con = null;
    ...
    +"Brand:-            Lakme 9 to 5 "+"\n"
    +"Product Name:-     Lakme 9 to 5 Compact - Silky Golden" +"\n"
    +"Price:-            499"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Com_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
