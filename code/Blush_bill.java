 ...
 * @author js
 */
public class Blush_bill extends javax.swing.JFrame {

    /**
     * Creates new form Blush_bill
     */
    Connection con = null;
...
public void Print(){
    ...
    +"Product Name:-     Makeup Revolution Ultra Blush - Sugar And Spice" +"\n"
    +"Price:-            1350"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Blush_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
