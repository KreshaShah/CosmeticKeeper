 ...
 * @author js
 */
public class High_bill extends javax.swing.JFrame {

    /**
     * Creates new form High_bill
     */
    Connection con = null;
    ...
    +"Brand:-            Nykaa"+"\n"
    +"Product Name:-     Nykaa Glow Getter Highlighting Duo Palette-Gliterrati 02" +"\n"
    +"Price:-            559"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(High_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
