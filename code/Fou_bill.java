 ...
 * @author js
 */
public class Fou_bill extends javax.swing.JFrame {
       
    /**
     * Creates new form Fou_bill
     */
        Connection con = null;
...
public void Print(){
    ...
    +"Product Name:-     Fit me Matte+Poreless liquid Foundation with pump  " +"\n"
    +"Price:-            549"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fou_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
