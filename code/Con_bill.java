 ...
 * @author js
 */
public class Con_bill extends javax.swing.JFrame {

    /**
     * Creates new form Con_bill
     */
    Connection con = null;
    ...
    +"Brand:-            Loreal Paris"+"\n"
    +"Product Name:-     L'Oreal Paris Infallible Full Wear Concealer - 314" +"\n"
    +"Price:-            649"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Con_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
