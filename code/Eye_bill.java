 ...
 * @author js
 */
public class Eye_bill extends javax.swing.JFrame {

    /**
     * Creates new form Eye_bill
     */
    Connection con = null;
...
public void Print(){
    ...
    +"Brand:-            Nykaa"+"\n"
    +"Product Name:-     Nykaa Eyes On Me! 10-in-1 Eyeshadow Palette - Smokey at 8! " +"\n"
    +"Price:-            599"+"\n"
    +"\n"+"********************");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eye_bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
